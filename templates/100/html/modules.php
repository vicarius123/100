...
function modChrome_artstyle($module, $params, $attribs)
{
  ...
  //  '...'        - overwrites the default module style.
  //  'suffix ...' - overwrites the default style and adds suffix to the module and
  //                     to its elements, does not add ... to the module elements.
...
<!-- begin nostyle -->
<div class="nostyle<?php echo $params->get('moduleclass_sfx'); ?>">
