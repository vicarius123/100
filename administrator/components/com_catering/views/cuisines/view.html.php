 ...
 * @since  1.6
 */
class CateringViewCuisines extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		CateringHelpersCatering::addSubmenu('cuisines');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_CATERING_TITLE_CUISINES'), 'cuisines.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_catering&view=cuisines');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`name`' => JText::_('COM_CATERING_CUISINES_NAME'),
		);
	}
}
