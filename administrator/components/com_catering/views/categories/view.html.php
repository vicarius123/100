 ...
 * @since  1.6
 */
class CateringViewCategories extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		CateringHelpersCatering::addSubmenu('categories');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_CATERING_TITLE_CATEGORIES'), 'categories.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_catering&view=categories');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`name`' => JText::_('COM_CATERING_CATEGORIES_NAME'),
		);
	}
}
