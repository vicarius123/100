 ...
 * @since  1.6
 */
class CateringControllerCategories extends JControllerAdmin
{
	/**
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_catering&view=categories');
	}
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'category', $prefix = 'CateringModel', $config = array())
	{
