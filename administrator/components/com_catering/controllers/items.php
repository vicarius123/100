 ...
 * @since  1.6
 */
class CateringControllerItems extends JControllerAdmin
{
	/**
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_catering&view=items');
	}
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'item', $prefix = 'CateringModel', $config = array())
	{
