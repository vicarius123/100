...
$document->addStyleSheet(JUri::root() . 'administrator/components/com_quiz_fabrika/assets/css/quiz_fabrika.css');
$document->addStyleSheet(JUri::root() . 'media/com_quiz_fabrika/css/list.css');

$user      = JFactory::getUser();
$userId    = $user->get('id');
$listOrder = $this->state->get('list.ordering');
$listDirn  = $this->state->get('list.direction');
$canOrder  = $user->authorise('core.edit.state', 'com_quiz_fabrika');
$saveOrder = $listOrder == 'a.`ordering`';

if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_quiz_fabrika&task=questions.saveOrderAjax&tmpl=component';
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="questionList">
				...
				<?php foreach ($this->items as $i => $item) :
					...
					$canCreate  = $user->authorise('core.create', 'com_quiz_fabrika');
					$canEdit    = $user->authorise('core.edit', 'com_quiz_fabrika');
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_quiz_fabrika&task=question.edit&id='.(int) $item->id); ?>">
