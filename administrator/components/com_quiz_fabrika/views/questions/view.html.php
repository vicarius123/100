...
class Quiz_fabrikaViewQuestions extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		Quiz_fabrikaHelper::addSubmenu('questions');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_QUIZ_FABRIKA_TITLE_QUESTIONS'), 'questions.png');

		// Check if the form exists before showing the add/edit buttons
		$formPath = JPATH_COMPONENT_ADMINISTRATOR . '/views/question';
		...
		if (file_exists($formPath))
		{
			if ($canDo->get('core.create'))
			{
				...
				{
					JToolbarHelper::custom('questions.duplicate', 'copy.png', 'copy_f2.png', 'JTOOLBAR_DUPLICATE', true);
				}
			}
		...
		{
			JToolBarHelper::preferences('com_quiz_fabrika');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_quiz_fabrika&view=questions');
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`question`' => JText::_('COM_QUIZ_FABRIKA_QUESTIONS_QUESTION'),
			'a.`parent`' => JText::_('COM_QUIZ_FABRIKA_QUESTIONS_PARENT'),
		);
	}
}
