 ...
 * @since  1.6
 */
class Quiz_fabrikaViewQuestion extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		$canDo = Quiz_fabrikaHelper::getActions();

		JToolBarHelper::title(JText::_('COM_QUIZ_FABRIKA_TITLE_QUESTION'), 'question.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_quiz_fabrika.question', $this->item->id);
		}
